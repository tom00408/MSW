...
extension User{
    static let TOM = User(id: UUID().uuidString, email: "Toms@troll.mail", username: "TomT", personalWallet: Wallet(id: UUID().uuidString, balance: 0, coins: ["BTC": 0.000853, "ETH" : 0.00859, "SOL": 10]))
